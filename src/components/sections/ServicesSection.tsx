...
export const ServicesSection = () => {
  ...
  return <section id="services" className="py-20 md:py-32 bg-web3-darkAlt">
      <div className="max-w-7xl mx-auto px-4 sm:px-6" ref={sectionRef}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => <div key={service.title} ref={el => cardsRef.current[index] = el} className="card-border rounded-xl p-8 opacity-0" style={{
