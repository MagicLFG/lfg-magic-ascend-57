      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((step, index) => (
            <div key={index} className="card-border p-6 rounded-xl bg-web3-dark/50 backdrop-blur-sm transition-all hover:scale-105 hover:bg-web3-dark/70">
              <div className="mb-4">
                {step.icon}
              </div>
              <h3 className="text-xl font-bold mb-1">{step.title}</h3>
              <p className="text-web3-purple font-medium mb-2">{step.subtitle}</p>
