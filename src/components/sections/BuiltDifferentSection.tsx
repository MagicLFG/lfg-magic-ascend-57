  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:gap-10 gap-8 justify-center items-stretch">
        {/* Mission Block */}
        <div className="flex-1 bg-web3-darkAlt/80 rounded-2xl p-8 glass-morphism border-2 border-web3-purple/30 group hover:shadow-[0_0_24px_6px_#8B5CF6aa] transition-all duration-300 animate-fade-in-up relative overflow-hidden">
          ...
          <p className="mb-5 text-lg text-white/90">
            We help Web3 projects break through in Asia with strategy, storytelling, and cultural fluency — not just campaigns, but scalable systems.
          </p>
          <a
            href="#"
        ...
        {/* Belief Block */}
        <div className="flex-1 bg-web3-darkAlt/80 rounded-2xl p-8 glass-morphism border-2 border-web3-purple/30 group hover:shadow-[0_0_24px_6px_#1EAEDB99] transition-all duration-300 animate-fade-in-up relative overflow-hidden">
          <div className="absolute top-6 right-6 opacity-30">
          ...
          <p className="mb-5 text-lg text-white/90">
            Web3 marketing shouldn’t be noise. It should be native, strategic, and fun enough to go viral — without losing structure.
          </p>
          <a
            href="#"
